...
import type { DeepSeekModel, IncomingMessage, SidebarTab, TranslationProvider } from './messages';
import {
      ...
      <aside className="side-panel" aria-hidden={!sidebarVisible}>
        ...
        {activeSidebarTab === 'translation' ? (
          <section className="side-tab-panel">
            <section className="tool-block">
              <h2>翻译模式</h2>
              <label htmlFor="translationProvider">选择如何翻译当前文本</label>
              <select
              ...
              >
                ...
                <option value="libretranslate">LibreTranslate（已配置服务）</option>
